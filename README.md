...
- Sales & Revenue Insights
  The top-selling products contribute to X% of total revenue.
  Sales have shown a Y% increase in the last quarter.
- Customer Insights
  Z% of customers are repeat buyers, indicating strong customer retention.
  The highest-spending customer segment is in the [region/category].
- Product Performance
  The fastest-moving products belong to the [category].
